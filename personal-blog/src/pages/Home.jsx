...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-purple-50/30 py-16 px-4 relative overflow-hidden">
            ...
            <div className="inline-flex items-center gap-3 p-2.5 bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-200/50 flex-wrap max-w-4xl">
              <button
                ...
                className={`px-6 py-2.5 rounded-xl font-semibold transition-all duration-300 whitespace-nowrap ${
                  currentCat === "all"
                    ? "bg-linear-to-r from-blue-600 to-purple-600 text-white shadow-lg shadow-blue-500/30 scale-105 hover:shadow-xl"
              ...
              {categories.length > 0 && <div className="h-8 w-px bg-linear-to-b from-transparent via-gray-300 to-transparent"></div>}
